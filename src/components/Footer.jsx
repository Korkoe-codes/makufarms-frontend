...
const Footer = () => {
  return (
    <section id="footer" className="w-full py-20 px-10 lg:py-48 md:py-32 md:px-16 lg:px-36 bg-[#0b132b]">
        <footer className="flex gap-5 container mx-auto  w-full md:flex-row flex-col">
      ...
      <div className="flex gap-5 md:justify-evenly flex-col md:flex-row w-full">
        ...
        <div className="flex flex-col gap-5">
          <h1 className="text-[#797D8A] text-base lg:text-lg xl:text-2xl font-bold">Have a Question?</h1>
