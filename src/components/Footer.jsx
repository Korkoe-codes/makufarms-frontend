...
const Footer = () => {
  return (
    <section className="w-full bg-[#0b132b]">
        <footer className="container mb-0 p-10 flex gap-5 lg:gap-0 mx-auto lg:items-center w-full justify-between">
          
      <div className="w-1/6  lg:w-1/12 p-1 flex justify-start">
        <img src={logos[2]} className="w-fit h-fit" />
      </div>
      <div className="flex gap-10 md:justify-evenly w-full">
        ...
        <div className="flex flex-col gap-2">
          <h1 className="text-[#797D8A] text-sm lg:text-lg font-bold">Contact Us</h1>
